...
const Core = require('hypercore/lib/core')
const BlockEncryption = require('hypercore/lib/block-encryption')
const Info = require('hypercore/lib/info')
const Download = require('hypercore/lib/download')
const Batch = require('hypercore/lib/batch')
const { manifestHash, createManifest } = require('hypercore/lib/verifier')
const { ReadStream, WriteStream, ByteStream } = require('hypercore/lib/streams')
const {
  ASSERTION,
  BAD_ARGUMENT,
  SESSION_CLOSED,

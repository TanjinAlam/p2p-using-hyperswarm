...
const RetryTimer = require('hyperswarm/lib/retry-timer')
const ConnectionSet = require('hyperswarm/lib/connection-set')
const PeerDiscovery = require('hyperswarm/lib/peer-discovery')
